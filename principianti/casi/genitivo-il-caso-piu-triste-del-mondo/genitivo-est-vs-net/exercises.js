...
// ============================================================
const p4cards = [
    { front: "У моей новой коллеги есть красная машина.", back: "У моей новой коллеги нет красной машины.", explanation: "Genitivo negativo: красная машина → красной машины (femminile)." },
    { front: "У моей двоюродной сестры есть маленькая собака.", back: "У моей двоюродной сестры нет маленькой собаки.", explanation: "Genitivo negativo: маленькая собака → маленькой собаки (femminile)." },
    { front: "У моей любимой бабушки есть старинная подруга.", back: "У моей любимой бабушки нет старинной подруги.", explanation: "Genitivo negativo: старинная подруга → старинной подруги (femminile)." },
    { front: "У моей любимой тёти есть большой сад.", back: "У моей любимой тёти нет большого сада.", explanation: "Genitivo negativo: большой сад → большого сада (maschile)." },
    { front: "У моей мамы есть интересная идея.", back: "У моей мамы нет интересной идеи.", explanation: "Genitivo negativo: интересная идея → интересной идеи (femminile)." },
    { front: "У нашей большой семьи есть большая машина.", back: "У нашей большой семьи нет большой машины.", explanation: "Genitivo negativo: большая машина → большой машины (femminile)." },
    { front: "У нашей собаки есть забавная привычка.", back: "У нашей собаки нет забавной привычки.", explanation: "Genitivo negativo: забавная привычка → забавной привычки (femminile)." },
    { front: "У моей университетской подруги есть огромная баня.", back: "У моей университетской подруги нет огромной бани.", explanation: "Genitivo negativo: огромная баня → огромной бани (femminile)." },
    { front: "У нашей строгой учительницы есть большая страсть.", back: "У нашей строгой учительницы нет большой страсти.", explanation: "Genitivo negativo irregolare (3ª declinazione): большая страсть → большой страсти (femminile)." },
    { front: "У моей мамы есть любимая книга.", back: "У моей мамы нет любимой книги.", explanation: "Genitivo negativo: любимая книга → любимой книги (femminile)." }
];
...
// ============================================================
const p5cards = [
    { front: "У моего отца есть новый мотоцикл.", back: "У моего отца нет нового мотоцикла." },
    { front: "У моего лучшего друга есть синий костюм.", back: "У моего лучшего друга нет синего костюма." },
    { front: "У моего молодого человека есть загородный дом.", back: "У моего молодого человека нет загородного дома." },
    { front: "У моего любимого парня есть жёлтый галстук.", back: "У моего любимого парня нет жёлтого галстука." },
    { front: "У нашего нового начальника есть хороший аргумент.", back: "У нашего нового начальника нет хорошего аргумента." },
    { front: "У нашего старого соседа есть старый пёс.", back: "У нашего старого соседа нет старого пса." },
    { front: "У моего ленивого друга есть интересный проект.", back: "У моего ленивого друга нет интересного проекта." },
    { front: "У моего старшего брата есть огромный чемодан.", back: "У моего старшего брата нет огромного чемодана." },
    { front: "У нашего нового профессора есть интересный курс.", back: "У нашего нового профессора нет интересного курса." },
    { front: "У моего младшего брата есть новый велосипед.", back: "У моего младшего брата нет нового велосипеда." }
];
