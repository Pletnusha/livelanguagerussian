...
const p5paragraphs = [
    ...
    "— Я до сих пор никуда пешком не {{19}}, — Тимур улыбнулся. — Тогда, помню, мода на самокаты появилась: я на нём ездил в универ, сейчас на [[моноколесе::monociclo elettrico]] — в офис. Конспекты больше не пишу, но записи {{23}}. Да, и на следующей неделе {{20}} на конференцию по праву — выступаю. Так что привычка быть звездой — осталась.",
