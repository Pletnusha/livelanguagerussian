...
// ============================================================
// PANEL 5 — GapText · paid · "За морем телушка — полушка, да рубль перевоз"
// Testo con lacune + glossario (no spiegazioni). Solo aspetto imperfettivo (НСВ).
// ============================================================
...
const p5paragraphs = [
    "Пятница, вечер. Компания сидела в любимом баре. Андрей допивал пиво, Женя поправлял дорогие часы, а Тимур и Дима рассматривали старые фотографии в телефоне. Разговор зашёл о поездке в Стамбул и о местных таксистах, которые превращали перемещение русских туристов по городу в финансовый квест.",
    "<strong>1.1</strong>",
    "— Я до сих пор с ужасом вспоминаю стамбульские такси! — хмыкнул Женя. — Мы садимся в машину, а водитель полчаса {{1}} нас по одним и тем же [[переулкам::vicoli]]! Я по Москве всегда пешком {{2}} или заказываю премиум-класс, а там нас просто кружили за наши же деньги.",
    "<strong>1.2</strong>",
    "— О да! — подхватил Андрей. — Помню, когда он {{3}} нас к Босфору, [[счётчик::tassametro]] крутился как бешеный. Я в обычной жизни на такси вообще не {{4}}, предпочитаю велосипед, а тут пришлось отдать половину наличных!",
    "<strong>1.3</strong>",
    "— Зато я сразу включил навигатор, — усмехнулся Тимур. — Пока этот [[лихач::automobilista spericolato]] {{5}} нас через мост, я показывал ему экран телефона. У стамбульских водителей привычка: они иностранных туристов специально кругами {{6}}, чтобы [[накрутить цену::gonfiare il prezzo]].",
    "<strong>1.4</strong>",
    "— А помните, как мы искали рыбный ресторан для Кати? — засмеялся Дима. — Таксист поклялся, что знает лучшее место, и целый час {{7}} нас по всему городу. Пока мы {{8}}, я чуть не умер от голода!",
    "<strong>1.5</strong>",
    "— Сервис просто катастрофа, — поморщился Женя. — В один из дней хитроумный таксист {{9}} нас по старому [[серпантину::tornanti]] на [[развалюхе::carretta]]. Я думал, мы до отеля не доберёмся. Когда я в Москве {{10}} коллег, я езжу аккуратно!",
    "<strong>1.6</strong>",
    "— Ты тогда весь сжался! — хохотнул Андрей. — Я смотрел в окно: пока машина {{11}} по горкам, ты кричал водителю: «Slow down!». А когда авто заглохло, мы три квартала пешком {{12}} и сами {{13}} свои тяжеленные чемоданы.",
    "<strong>1.7</strong>",
    "— Пешком ходить полезно! — заметил Тимур. — Я же каждое утро в отеле вставал и {{14}} вдоль набережной. Кстати, когда мы потом опаздывали на [[паром::traghetto]], мы все вместе {{15}} за уходящим кораблём, пока стамбульские коты удивлённо смотрели нам вслед.",
    "<strong>1.8</strong>",
    "— Короче, вылазка удалась, — резюмировал Дима. — Но если мы снова полетим в Стамбул, пусть меня больше никакие водители кругами не {{16}}! Проще на трамвае {{17}}.",
];
