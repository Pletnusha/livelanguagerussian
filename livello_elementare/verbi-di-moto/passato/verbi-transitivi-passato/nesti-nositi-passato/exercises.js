...
// ============================================================
// PANEL 5 — GapText · paid · "Семь раз отмерь — один раз переедь"
// Testo con lacune + glossario (no spiegazioni).
// Verbi testati: ходить/идти, ехать/ездить, бегать/бежать, нести/носить,
// + anteprima di возить/везти (pagina dedicata non ancora pubblicata,
// ma introdotta qui in anticipo per rinforzo). держать NON è una lacuna
// (verbo diverso, argomento futuro).
// ============================================================
const p5instruction = "Leggi il racconto e scrivi la forma corretta del verbo (ходить/идти, ехать/ездить, бегать/бежать, нести/носить, возить/везти), al presente, al passato o all'infinito. Clicca sulle parole sottolineate per vedere la traduzione in italiano.";

const p5paragraphs = [
    "Пятница, вечер. Друзья сидели в любимом баре и вспоминали, как три месяца назад Дима переезжал от Андрея на новую квартиру. Процесс был хаотичным: Катя командовала, Анна организовывала коробки, Лена всё упаковывала, Андрей, Дима и Тимур таскали тяжести, а Женя отвечал за логистику.",
    "<strong>1.1</strong>",
    "— Я до сих пор помню этот ужас! — вздохнул Андрей, заказывая пиво. — Мы весь день {{1}} твои коробки с пятого этажа. Я обычно в банк пешком {{2}}, а тут целый день {{3}} вещи. Андрюх, помнишь этот тяжеленный шкаф! Мы, когда несли его, чуть не надорвались.",
    "<strong>1.2</strong>",
    "— Зато какая тренировка! — усмехнулся Тимур. — Помнишь, как я весь день {{4}} вверх и вниз по лестнице? Пока я {{5}} по этажам с твоим телевизором, я сжёг тысячу калорий. Переезд был лучше любого спортзала!",
    "<strong>1.3</strong>",
    "— Физический труд — это не моё, — сдержанно заметил Женя, поправляя пиджак. — Я весь день {{6}} вещи на машине. Мы {{7}} туда-обратно раз двадцать! С тех пор я в багажнике ничего не {{8}} — он так и не открывается.",
    "<strong>1.4</strong>",
    "— Вы бы вообще ничего не перевезли без нас! — Катя отпила чай. — Я только и делала что {{9}} по квартире и контролировала коробки и надписи на них. Пока Анна {{10}} вещи из комнат, а Лена всё упаковывала, вы с Андреем просто хаотично {{11}} по коридору взад-вперёд.",
    "<strong>1.5</strong>",
    "— И не спорьте! — подтвердила Анна. — Вы с Андреем постоянно {{12}} какие-то непарные носки вместо коробок. — Мы не носили, мы находили, — возразил Дима. — А я, когда {{13}} на заднем сиденье котёнка Глюка... — начала Анна, [[меняя тему::cambiando argomento]]. — А ты, между прочим, {{14}} и держал на коленях аквариум с рыбками!",
    "<strong>1.6</strong>",
    "— Вспомнил! — засмеялся Андрей. — Когда мы {{15}} на новую квартиру, а Дима отказался везти рыбок в банке и держал на коленях открытый аквариум! Женя {{16}} нас и ругался всю дорогу! — Ещё бы! — поморщился Женя. — Я никогда не {{17}} такой бардак в своей машине. Когда я даже {{18}} с дачи, у меня в машине идеальный порядок.",
    "<strong>1.7</strong>",
    "— Катя, а помнишь, как ты {{19}} ту огромную вазу? — улыбнулся Тимур. — Ты же ненавидишь носить тяжести! — Я её спасала от вас! — парировала Катя. — Сейчас, когда я {{20}} на рынок за овощами, я иду с Тимуром, чтобы ничего тяжелее зелени не {{21}} самой. Он ходит ко мне стирать и носит мои сумки.",
    "<strong>1.8</strong>",
    "— Спасибо всем, друзья, вы лучшие! — Дима с надеждой посмотрел на компанию. — Кстати... Тим, ты же завтра утром {{22}} в мою сторону? А Женя всё равно {{23}} с работы мимо... Поможете диван подвинуть? — Даже не думай! — хором ответила БАНДА.",
];
...
// ============================================================
// PANEL 6 — GapText · paid · "У страха глаза велики"
// Testo con lacune + glossario (no spiegazioni).
// Verbi testati: ходить/идти, ехать/ездить, бегать/бежать, нести/носить,
// возить/везти (in anteprima, come nel panel 5). держать e "носился"
// (uso intensivo non annotato) restano testo fisso.
// ============================================================
const p6instruction = "Leggi il racconto e scrivi la forma corretta del verbo (ходить/идти, ехать/ездить, бегать/бежать, нести/носить, возить/везти), al presente, al passato o all'infinito. Clicca sulle parole sottolineate per vedere la traduzione in italiano.";

const p6paragraphs = [
    "Пятница, вечер. Компания сидела в любимом баре. Андрей доедал второй бургер, Женя поправлял пиджак, а Дима показывал свежие царапины. Ребята вспоминали [[безбашенную::pazzesca, scriteriata]] поездку в клинику, когда они помогали Диме транспортировать котёнка Глюка.",
    "<strong>1.1</strong>",
    "— Это была самая безбашенная поездка в моей жизни! — поморщился Женя. — Я всегда {{1}} на чистой машине, а тут мы {{2}} кота да ещё без [[переноски::trasportino (per gatti)]]! И прямо посреди дороги машина сломалась.",
    "<strong>1.2</strong>",
    "— И нам пришлось импровизировать, — вздохнул Дима. — Помните, как мы {{3}} два квартала? Я {{4}} Глюка на руках, а он вырывался и царапался. Я обычно на руках его не {{5}}, ему не нравится, он вырывается всегда, а тут держал его изо всех сил!",
    "<strong>1.3</strong>",
    "— А не надо было полчаса спорить у сломанной машины! — вмешался Андрей, отпивая пиво. — Я сразу предлагал {{6}} на автобусе, Женя хотел {{7}} на такси, а Тимур кричал, что лучше быстро {{8}} пешком. И пока мы спорили, Глюк выпрыгнул из рук!",
    "<strong>1.4</strong>",
    "— Вся улица хохотала! — засмеялся Тимур. — Вы целых десять минут {{9}} вокруг сквера! Но пока вы паниковали, я {{10}} за ним через сквер. Я же каждый день по утрам {{11}}, вот дисциплина и спасла кота!",
    "<strong>1.5</strong>",
    "— В итоге я всё равно победил, и мы решили {{12}} на такси, — гордо сказал Женя. — Но пока мы {{13}} в клинику, этот пушистый монстр опять вырвался! И всех перецарапал.",
    "<strong>1.6</strong>",
    "— Нашёл успокоение у водителя такси! Предатель! И всю оставшуюся дорогу он {{14}} мирно спящим на коленях у водителя! — хохотнул Андрей. — Водитель только улыбался. А я в это время {{15}} его мокрый [[ошейник::collare]] и думал о пиве. — Так у тебя был ошейник?! Ты почему не сказал?! — Я говорил, просто ты был далеко — ты бегал за Глюком и не слышал.",
    "<strong>1.7</strong>",
    "— Главное — Глюк здоров, — улыбнулся Дима. — Теперь я каждый месяц {{16}} его на осмотр. И мы больше пешком не {{17}}, и на руках его по улице не {{18}} — я наконец купил нормальный пластиковый бокс, ношу его только в нём.",
    "<strong>1.8</strong>",
    "— Отличная покупка! — одобрил Тимур. — А то когда я вчера {{19}}, увидел кота в переноске и вспомнил, как Глюк носился по салону машины, орал и всех царапал. И да, сегодня утром я снова {{20}} мимо той ветеринарки — в общем, этот кросс крепко засел в памяти!",
];
...
function initPanel7() {
    ...
    const multipleChoiceData = [
        { question: "В детстве мы ___ воду из колодца на даче.", options: ["носили", "носила", "носил"], answer: "носили" },
        { question: "Она ___ букет цветов на день рождения подруги.", options: ["несла", "нёс", "несли"], answer: "несла" },
        { question: "Она каждый день ___ ноутбук в рюкзаке.", options: ["носила", "носил", "носили"], answer: "носила" },
        { question: "Катя ___ торт очень осторожно, чтобы не уронить.", options: ["несла", "нёс", "несли"], answer: "несла" },
        { question: "Она ___ чёрное на все вечеринки — это был её стиль.", options: ["носила", "носил", "носили"], answer: "носила" },
        { question: "Вчера он ___ тяжёлую сумку из магазина.", options: ["нёс", "несла", "несли"], answer: "нёс" },
        { question: "Раньше он всегда ___ тяжёлые сумки сам, без курьера.", options: ["носил", "носила", "носили"], answer: "носил" },
        { question: "Директор ___ полную ответственность за провал проекта.", options: ["нёс", "несла", "несли"], answer: "нёс" },
        { question: "Он два года ___ обручальное кольцо, не снимая.", options: ["носил", "носила", "носили"], answer: "носил" },
        { question: "Мы ___ чемоданы к такси всё утро.", options: ["несли", "нёс", "несла"], answer: "несли" },
    ];
    const matchPairs = [
        { left: "Мы ___ школьную форму каждый день.", right: "носили" },
        { left: "Он весь вечер ___ какую-то чушь после третьего бокала.", right: "нёс" },
        { left: "Он никогда не ___ зонт, даже в дождь.", right: "носил" },
        { left: "Дети ___ воздушные шарики с праздника домой.", right: "несли" },
        { left: "Дети ___ рюкзаки в школу каждое утро.", right: "носили" },
        { left: "Пока она ___ посылку на почту, начался дождь.", right: "несла" },
        { left: "Она долго ___ девичью фамилию после свадьбы.", right: "носила" },
        { left: "Мы ___ ёлку из леса вдвоём.", right: "несли" },
        { left: "Раньше они ___ воду вёдрами, пока не провели водопровод.", right: "носили" },
        { left: "Он ___ букет так, будто это было что-то хрупкое.", right: "нёс" },
    ];
    const quizData = [
        { id: "q01", promptPrefix: "Я тоже ", promptSuffix: " вещи в химчистку.", answers: ["носил"] },
        { id: "q02", promptPrefix: "Куда мне ", promptSuffix: " этот огромный пакет с грязными вещами?", answers: ["нести"] },
        { id: "q03", promptPrefix: "Я вот ", promptSuffix: " рубашки, костюмы и постельное бельё в прачечную.", answers: ["ношу"] },
        { id: "q04", promptPrefix: "Когда ты сам в руках ", promptSuffix: " грязное бельё.", answers: ["несёшь"] },
        { id: "q05", promptPrefix: "Меня в школе заставляли ", promptSuffix: " ужасную школьную форму.", answers: ["носить"] },
        { id: "q06", promptPrefix: "Если мне надо ", promptSuffix: " тяжёлые вещи...", answers: ["нести"] },
        { id: "q07", promptPrefix: "На руках его не ", promptSuffix: ", ему не нравится.", answers: ["ношу"] },
        { id: "q08", promptPrefix: "Катя, а помнишь, как ты ", promptSuffix: " ту огромную вазу?", answers: ["несла"] },
        { id: "q09", promptPrefix: "На руках его по улице не ", promptSuffix: ".", answers: ["носим"] },
        { id: "q10", promptPrefix: "Я в это время ", promptSuffix: " его мокрый ошейник.", answers: ["нёс"] },
    ];
