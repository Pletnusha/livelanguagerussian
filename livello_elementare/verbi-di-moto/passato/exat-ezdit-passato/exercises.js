...
// ============================================================
// PANEL 5 — GapText · paid · "Лебедь, Рак и Щука"
// (showHints: false). Verbi testati: ходить/идти, ехать/ездить,
// водить, нести, лететь — passato, presente e infinito.
// Il racconto resta autentico/ricco (бегать, плавать, возить/везти
// compaiono nel testo) ma quei verbi NON sono lacune: sono già
// scritti nel testo, perché non ancora studiati su questa pagina.
// ============================================================
const p5instruction = "Leggi il racconto e scrivi la forma corretta del verbo (ходить/идти/ехать/ездить, водить, нести, лететь), al presente, al passato o all'infinito. Clicca sulle parole sottolineate per vedere la traduzione in italiano.";

const p5paragraphs = [
    "На прошлые выходные компания решила поехать в национальный парк. Даша всё спланировала, но идеальная логистика [[рухнула::è crollata]] в первый же день. У каждого оказались свои планы и привычки. В пятницу в баре друзья пытаются [[восстановить::ricostruire]] картину хаоса.",
    "<strong>1.1</strong>",
    "— Я больше с вами никуда не {{1}}! — заявила Даша, бросив ключи на стол. — Я {{2}} машину десять лет, но такого кошмара ещё не было! Я {{3}} за рулём три часа, а Андрей всю дорогу [[жаловался::si lamentava]] на жизнь. — Потому что мы {{4}} по ужасной [[грунтовой дороге::strada sterrata]]! — возмутился Андрей. — Я обычно {{5}} только в центр на самокате за бургерами. Зачем мы вообще туда {{6}}? Там даже банкомата нет!",
    "<strong>1.2</strong>",
    "— Пока мы {{7}} к нашему домику, мы увидели Тимура у озера. — У меня [[строгий режим::programma rigido]], — невозмутимо ответил Тимур. — Я каждый день бегаю: пятнадцать километров. И плаваю каждое утро — базовая кардионагрузка. — Представляете картину? — засмеялась Катя. — Тимур бежал [[вдоль::lungo]] озера, а рядом лебедь плыл. Лебеди плыли спокойно, а Тимур бежал как на Олимпиаде! — Я тоже люблю плавать, — сказал Андрей. — Но в ванне. С пивом.",
    "<strong>1.3</strong>",
    "— А мы с Катей {{8}} по [[экологической тропе::sentiero ecologico]], — элегантно поправил свои дорогущие часы Женя. — Я очень люблю {{9}} пешком. Это базовая физическая нагрузка. — Мы часто {{10}} в походы ради общения с природой, — кивнула Катя. — Пока мы {{11}} [[между деревьями::tra gli alberi]], мы слушали пение птиц. В парке птицы {{12}} так низко! И [[вдруг::all'improvviso]] — [[аист::cicogna]] {{13}} прямо над головой! — Птицы {{14}} и в городе, — зевнул Андрей. — В городе {{15}} [[голуби::piccioni]], Андрей. Голуби. — А потом мы увидели Анну. Анна, куда ты {{16}} с огромным рюкзаком?",
    "<strong>1.4</strong>",
    "— Я {{17}} в [[соседнюю деревню::villaggio vicino]]! — гордо ответила Анна. — Я всегда {{18}} на [[рынки::mercati]], когда есть фермеры. Там было [[парное мясо::carne fresca]]! — Ты {{19}} пять километров пешком за куском говядины?! — Андрей [[чуть не подавился::stava per strozzarsi]] пивом. — Конечно! И я всегда {{20}} большой рюкзак. {{21}} мясо, {{22}} сыр, {{23}} молоко — пять кило! {{24}} легко. — Ты {{25}} пять кило через лес одна? — удивился Дима. — А что? Движение — это жизнь! Зато Андрей ничего не {{26}}, [[кроме::a parte]] телефона. — И пока я {{27}} обратно, я [[встретила::ho incontrato]] Диму. Дима, зачем ты {{28}} на велосипеде в сторону шоссе?",
    "<strong>1.5</strong>",
    "— Я искал [[зоомагазин::negozio di animali]], — вздохнул Дима. — Я забыл купить корм для Глюка! Я {{29}} на велосипеде Андрея почти час, но там был только лес. — На велосипеде Андрея?! — удивилась Даша. — Он же всё равно лежал в [[гамаке::amaca]]! А я каждую неделю {{30}} в зоомагазин. И {{31}} Глюка к ветеринару каждый месяц. А когда везу его в машине — он [[мяукает::miagola]] всю дорогу. — Зачем ты возишь кота в национальный парк? — спросил Женя. — Глюк — [[член семьи::membro della famiglia]]!",
    "<strong>1.6</strong>",
    "— В итоге, — Женя элегантно поправил свои дорогущие часы. — Тимур бегал и плавал. Анна {{32}} за мясом и {{33}} рюкзак. Дима ехал за кормом и возит кота. Катя {{34}} в походы. Я {{35}} пешком. Птицы {{36}}. А Андрей… лежит. — Неправда! — обиделся Андрей. — Вот прямо сейчас я {{37}} к бару за бургером. Это тоже движение! — Подождите, — сказала Даша. — Кто всех везёт домой? Я сегодня не {{38}} — три [[бокала::bicchieri]]. — Женя! — предложил Андрей. — Он не пьёт! — Я не {{39}} машину, — ответил Женя. — Я {{40}} пешком. Всегда. — Мы как в басне, — вздохнула Катя. — [[Лебедь::cigno]], [[рак::gambero]] и [[щука::luccio]]. Каждый [[тянет::tira]] в свою сторону. Лебедь {{41}} неспеша, рак [[ползёт::striscia]]… — А щука лежит [[на дне::sul fondo]] и не двигается, — закончил Андрей. — Это я.",
];
