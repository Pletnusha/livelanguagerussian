...
const p2cards = [
    ...
    { front: "Зачем ты за ним бегаешь?", back: "Я бегу на встречу.", explanation: "«Бегать за кем-то» = inseguire abitualmente → бегать. «Бегу на встречу» = sto correndo verso un appuntamento adesso → бежать." },
    { front: "Перед тренировкой я всегда бегаю минут 15.", back: "Я бегу на тренировку.", explanation: "«Всегда» + «минут 15» = abitudine regolare → бегать. «Бегу на тренировку» = sto correndo verso l'allenamento adesso → бежать." },
    { front: "Наш пес всегда бежит мне навстречу.", back: "Наш пес бегает за мячиком.", explanation: "«Бежит навстречу» = corsa direzionale verso di me → бежать. «Бегает за мячиком» = inseguire il pallone, azione ripetuta → бегать." },
    { front: "Куда ты бежишь?", back: "Бегу домой. Гости придут через час, а у меня ужин ещё не готов.", explanation: "«Куда» + urgenza → бежать. La risposta conferma: corre verso casa adesso, causa concreta → бежать." },
    { front: "Кот бежит к миске.", back: "Кот бегает за клубком.", explanation: "«К миске» = direzione precisa adesso → бежать. «За клубком» = inseguire il gomitolo, azione ripetuta → бегать." },
];
...
// ============================================================
const p7cards = [
    { front: "Куда ты бежишь?", back: "Я бегу на работу." },
    { front: "Тренер бегает туда-обратно! Волнуется за команду.", back: "Тренер бежит к полю, судья дал штрафное очко команде." },
    { front: "Смотрите — гепард бежит за газелью!", back: "Гепарды бегают со скоростью 112 км в час." },
    { front: "Мы бежим на лекцию! Опаздываем.", back: "Мы бегаем в бар на переменах." },
    { front: "Я бегаю как белка в колесе.", back: "Белка бежит к нам, мы принесли ей корм." },
    { front: "Дети бегут домой — пошёл дождь.", back: "Дети бегают под дождём." },
    { front: "Смотри, наш сын бежит в первой пятёрке, надеюсь он выиграет.", back: "Наш сын каждый день бегает по 15 километров, готовится к соревнованиям." },
    { front: "Вы бежите марафон.", back: "Вы каждый год бегаете этот марафон?" },
    { front: "Мы бежим на вокзал.", back: "Мы уже час бегаем по вокзалу — ищем платформу нашего поезда." },
    { front: "Она так быстро бегает?!", back: "Она бежит ему навстречу." },
];
...
// ============================================================
const p8cards = [
    { front: "Наша команда бежит второй круг по стадиону.", back: "Наша команда бегает каждый день несколько кругов по стадиону." },
    { front: "Я бегу на автобус.", back: "Каждое утро я бегаю за этим автобусом — никогда не приходит по расписанию." },
    { front: "Куда ты бежишь?", back: "Я бегу на работу." },
    { front: "Собаки бегают друг за другом — играют.", back: "Пес бежит к хозяину." },
    { front: "В какую сторону вы бежите по пляжу?", back: "Вы каждое утро бегаете по пляжу?" },
    { front: "Мы бежим в бар выпить кофе.", back: "В обед мы всегда бегаем пить кофе в этот бар." },
    { front: "Зачем ты за ним бегаешь?", back: "Я бегу на встречу." },
    { front: "Он бежит в офис.", back: "Он бегает в центральный офис несколько раз в день." },
    { front: "Вы бежите марафон.", back: "Вы каждый год бегаете этот марафон?" },
    { front: "Мы бежим на рынок за продуктами.", back: "Мы никогда не бегаем по рынку, всегда спокойно ходим и выбираем продукты." },
];
...
// ============================================================
const p9cards = [
    { front: "Наша команда каждый день", back: "бегает по стадиону." },
    { front: "Завтра бабушка", back: "идёт к врачу." },
    { front: "Машина сломалась, вот я", back: "еду на метро!" },
    { front: "Смотрите — гепард", back: "бежит за газелью!" },
    { front: "По средам Лена", back: "ходит на йогу." },
    { front: "Он опаздывает и", back: "бежит на автобус." },
    { front: "Она сейчас уже в поезде —", back: "едет в Верону." },
    { front: "Тренер туда-обратно —", back: "бегает, волнуется за команду." },
    { front: "Тихо — учитель уже", back: "идёт!" },
    { front: "Мы к родителям на машине", back: "ездим каждые выходные." },
];
