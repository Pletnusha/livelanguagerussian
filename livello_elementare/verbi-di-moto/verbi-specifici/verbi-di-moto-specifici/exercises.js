...
const p11exercises = [
    {
        instruction: "Выбери правильную форму глагола.",
        text: "В понедельник я {{1}} в Милан.",
        words: ["лечу", "летаю", "летит"],
        correctAnswers: { 1: "лечу" }
    },
    {
        instruction: "Выбери правильную форму глагола.",
        text: "Я никогда не {{1}} с пересадками.",
        words: ["летаю", "лечу", "летит"],
        correctAnswers: { 1: "летаю" }
    },
    {
        instruction: "Выбери правильную форму глагола.",
        text: "Ты часто {{1}} в Милан?",
        words: ["летаешь", "летишь", "летает"],
        correctAnswers: { 1: "летаешь" }
    },
    {
        instruction: "Выбери правильную форму глагола.",
        text: "Куда {{1}} этим летом?",
        words: ["летаешь", "летишь", "летит"],
        correctAnswers: { 1: "летишь" }
    },
    {
        instruction: "Выбери правильную форму глагола.",
        text: "Она всегда {{1}} в Лондон на распродажи.",
        words: ["летит", "летает", "летишь"],
        correctAnswers: { 1: "летает" }
    },
    {
        instruction: "Выбери правильную форму глагола.",
        text: "Он {{1}} в Японию через неделю.",
        words: ["летает", "летит", "лечу"],
        correctAnswers: { 1: "летит" }
    },
    {
        instruction: "Выбери правильную форму глагола.",
        text: "Мы никуда никогда не {{1}}, Андрей боится летать.",
        words: ["летим", "летаем", "летают"],
        correctAnswers: { 1: "летаем" }
    },
    {
        instruction: "Выбери правильную форму глагола.",
        text: "На следующей неделе мы {{1}} в Марокко.",
        words: ["летаем", "летим", "летят"],
        correctAnswers: { 1: "летим" }
    },
    {
        instruction: "Выбери правильную форму глагола.",
        text: "Куда вы обычно {{1}} в отпуск?",
        words: ["летите", "летаете", "летят"],
        correctAnswers: { 1: "летаете" }
    },
    {
        instruction: "Выбери правильную форму глагола.",
        text: "Вы так часто {{1}}?!",
        words: ["летите", "летаете", "летают"],
        correctAnswers: { 1: "летаете" }
    },
    {
        instruction: "Выбери правильную форму глагола.",
        text: "Вы куда-нибудь {{1}} после Нового года?",
        words: ["летаете", "летите", "летят"],
        correctAnswers: { 1: "летите" }
    },
    {
        instruction: "Выбери правильную форму глагола.",
        text: "Они {{1}} на Мальдивы пару раз в год.",
        words: ["летят", "летают", "летите"],
        correctAnswers: { 1: "летают" }
    },
    {
        instruction: "Выбери правильную форму глагола.",
        text: "В понедельник они {{1}} в Монако.",
        words: ["летают", "летят", "летим"],
        correctAnswers: { 1: "летят" }
    },
];
...
// ============================================================
const p2cards = [
    { front: "В эту субботу",       back: "он плывёт на яхте в открытое море." },
    { front: "Каждое утро",         back: "она бегает в парке." },
    { front: "Сейчас",              back: "они бегут на автобус." },
    { front: "Обычно зимой",        back: "мы летаем в тёплые страны." },
    { front: "Через час",           back: "я лечу в Париж." },
    { front: "Каждые выходные",     back: "он плавает в бассейне." },
    { front: "Прямо сейчас",        back: "они плывут к берегу." },
    { front: "Два раза в неделю",   back: "она летает в Москву." },
    { front: "Куда ты сейчас",      back: "бежишь?" },
    { front: "По воскресеньям",     back: "мы бегаем по набережной." },
];
