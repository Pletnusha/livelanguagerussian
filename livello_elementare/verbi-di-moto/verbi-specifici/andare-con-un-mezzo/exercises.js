...
const p2cards = [
    ...
    { front: "Она едет в Верону на машине.", back: "Она всегда ездит в Верону на машине.", explanation: "Nessun segnale di frequenza → viaggio specifico adesso → ехать. «Всегда» = abitudine consolidata → ездить. Stessa destinazione, frequenza diversa." },
    { front: "Вы часто ездите за город?", back: "Да, мы обычно ездим за город пару раз в месяц.", explanation: "«Часто» nella domanda e «обычно» + «пару раз в месяц» nella risposta — entrambe descrivono un'abitudine → ездить. Nessun viaggio specifico." },
    { front: "Анна любит ездить в парк кататься на велосипеде.", back: "Ты едешь в парк сегодня утром?", explanation: "«Любит ездить» = infinito per un'attitudine abituale → ездить. «Сегодня утром» = viaggio specifico pianificato → ехать." },
    { front: "В понедельник еду в командировку.", back: "Я езжу в командировки каждый месяц.", explanation: "«В понедельник» = partenza specifica → ехать. «Каждый месяц» = frequenza → ездить. Stessa situazione lavorativa, frequenza diversa." },
    { front: "Кто едет со мной в баню?", back: "Мы ездим в баню раз в месяц.", explanation: "«Кто едет» = questa volta, adesso → ехать. «Раз в месяц» = frequenza → ездить. Chi viene adesso vs chi viene di solito." },
];
...
const p7cards = [
    ...
    { front: "Куда вы в этом году едете в отпуск?", back: "Вы каждый год ездите в отпуск на Сардинию?" },
    { front: "Машина сломалась, вот я еду на метро!", back: "Ненавижу ездить на метро — там постоянно толпа!" },
    { front: "Анна любит ездить в парк кататься на велосипеде.", back: "Ты едешь в парк сегодня утром?" },
    { front: "В понедельник еду в командировку.", back: "Я езжу в командировки каждый месяц." },
    { front: "Кто едет со мной в баню?", back: "Мы ездим в баню раз в месяц." },
    { front: "Почему ты всегда ездишь на автобусе, на метро же быстрее?", back: "Я еду на метро сегодня, забастовка транспорта." },
];
...
const p8cards = [
    ...
    { front: "В субботу мы едем в горы!", back: "Мне нравится ездить в горы." },
    { front: "Кто едет со мной в баню?", back: "Мы ездим в баню раз в месяц." },
    { front: "Куда вы в этом году едете в отпуск?", back: "Вы каждый год ездите в отпуск на Сардинию?" },
    { front: "Я еду в супермаркет за вином.", back: "Мы ездим в супермаркет по субботам." },
    { front: "Почему ты всегда ездишь на автобусе, на метро же быстрее?", back: "Я еду на метро сегодня, забастовка транспорта." },
