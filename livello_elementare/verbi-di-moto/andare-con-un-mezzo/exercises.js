...
// ============================================================
const p2cards = [
    { front: "Как обычно",              back: "едем на Бали на пару месяцев" },
    { front: "Мне нравится",            back: "ездить в горы" },
    { front: "Утром она",               back: "едет к родителям" },
    { front: "Я обычно в городе",       back: "не езжу на машине — постоянно пробки!" },
    { front: "Куда",                    back: "едете в отпуск в этом году?" },
    { front: "Как часто ты",            back: "ездишь в гости к бабушке?" },
    { front: "Я",                       back: "еду в супермаркет за вином" },
    { front: "Мы обычно",               back: "ездим на дачу, на шашлыки" },
    { front: "Наш сын научился",        back: "ездить на велосипеде" },
    { front: "Женя уже",                back: "едет за мной" },
];
...
const p8cards = [
    ...
    { front: "Они всегда",      back: "ездят на велосипедах в воскресенье" },
    { front: "Обычно ты",       back: "ездишь на трамвае?" },
    { front: "Мне нравится",    back: "ездить в горы" },
    { front: "Утром она",       back: "едет к родителям" },
...
const p3cards = [
    ...
    { front: "Они всегда",             back: "ездят на велосипедах в воскресенье" },
    { front: "Ты же на машине",        back: "ездишь на работу" },
    { front: "Машина сломалась, вот",  back: "еду на метро!" },
    { front: "Я сейчас в поезде,",     back: "еду к маме" },
    { front: "Мне очень нравится",     back: "ездить на самокате" },
    { front: "Мы ездим к родителям",   back: "на машине каждые выходные" },
    { front: "Он после обеда",         back: "едет в ИКЕА" },
...
function initPanel4() {
    ...
    const matchPairs = [
        ...
        { left: "Каждый день он",               right: "ездит на работу на метро" },
        { left: "Завтра мы",                    right: "едем к родителям на машине" },
        { left: "На следующей неделе она",      right: "едет в Москву на конференцию" },
        { left: "По пятницам они",              right: "ездят за город" },
        { left: "Я сейчас",                     right: "еду на вокзал" },
        { left: "Он всегда",                    right: "ездит на работу на велосипеде" },
        { left: "В субботу мы",                 right: "едем на дачу" },
        { left: "Они обычно",                   right: "ездят на море летом" },
    ];
    ...
    const quizData = [
        ...
        { id: "mezzo-003", promptPrefix: "Наши друзья всегда",         promptSuffix: "на дачу в субботу.",                       answers: ["ездят"] },
        { id: "mezzo-004", promptPrefix: "Куда ты",                    promptSuffix: "сейчас?",                                  answers: ["едешь"] },
        { id: "mezzo-005", promptPrefix: "Мы",                         promptSuffix: "в Рим в эту пятницу.",                     answers: ["едем"] },
        { id: "mezzo-006", promptPrefix: "Они никогда не",             promptSuffix: "на такси.",                                answers: ["ездят"] },
        { id: "mezzo-007", promptPrefix: "Когда вы",                   promptSuffix: "в отпуск?",                                answers: ["едете"] },
        { id: "mezzo-008", promptPrefix: "Она каждое лето",            promptSuffix: "в деревню.",                               answers: ["ездит"] },
        { id: "mezzo-009", promptPrefix: "Я",                          promptSuffix: "в аэропорт на такси.",                     answers: ["еду"] },
        { id: "mezzo-010", promptPrefix: "Ты",                         promptSuffix: "на работу на автобусе?",                   answers: ["ездишь"] },
    ];
