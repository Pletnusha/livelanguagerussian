...
const p1exercises = [
    {
        ...
        text: "По выходным мы {{1}} на электричке на дачу.",
    ...
    {
        instruction: "Выбери правильную форму глагола движения с транспортом.",
        text: "Каждое утро я {{1}} на работу на метро.",
        words: ["еду", "езжу", "едет"],
        correctAnswers: { 1: "езжу" }
    },
    {
        instruction: "Выбери правильную форму глагола движения с транспортом.",
        text: "Завтра они {{1}} к бабушке на электричке.",
        words: ["ездят", "едут", "едем"],
        correctAnswers: { 1: "едут" }
    },
    {
        instruction: "Выбери правильную форму глагола движения с транспортом.",
        text: "Он каждые выходные {{1}} в парк на велосипеде.",
        words: ["едет", "ездит", "едут"],
        correctAnswers: { 1: "ездит" }
    },
    {
        instruction: "Выбери правильную форму глагола движения с транспортом.",
        text: "Мы в эту субботу {{1}} на море на машине.",
        words: ["ездим", "едем", "едут"],
    ...
    },
    {
        ...
        words: ["ездите", "едете", "едем"],
        correctAnswers: { 1: "едете" }
    },
    {
        instruction: "Выбери правильную форму глагола движения с транспортом.",
        text: "Мы обычно {{1}} к друзьям на дачу на машине.",
        words: ["едем", "ездим", "едут"],
        correctAnswers: { 1: "ездим" }
    },
    {
