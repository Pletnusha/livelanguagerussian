...
const p1exercises = [
    {
        instruction: "Completa la frase con la forma corretta del verbo ХОДИТЬ (Ходить vs Идти)",
        text: "Мы обычно {{1}} завтракать в бар рядом с домом. Моя соседка никогда не {{2}} завтракать в этот бар.",
        words: ["ходим", "ходит", "хожу", "ходишь"],
        correctAnswers: { 1: "ходим", 2: "ходит" }
    },
    {
        instruction: "Completa la frase con la forma corretta del verbo ХОДИТЬ (Ходить vs Идти)",
        text: "Ты часто {{1}} в спортзал? Нет, я {{2}} только два-три раза в неделю.",
        words: ["ходишь", "хожу", "ходит", "ходим"],
        correctAnswers: { 1: "ходишь", 2: "хожу" }
    },
    {
        instruction: "Completa la frase con la forma corretta del verbo ХОДИТЬ (Ходить vs Идти)",
        text: "Вы часто сюда {{1}}? Да, в этот ресторан мы {{2}} почти каждые выходные.",
        words: ["ходите", "ходим", "ходит", "хожу"],
        correctAnswers: { 1: "ходите", 2: "ходим" }
    },
    {
        instruction: "Completa la frase con la forma corretta del verbo ХОДИТЬ (Ходить vs Идти)",
        text: "Она часто {{1}} на берег моря. Я {{2}} на пробежку по берегу моря каждое утро.",
        words: ["ходит", "хожу", "ходишь", "ходим"],
        correctAnswers: { 1: "ходит", 2: "хожу" }
    },
    {
        instruction: "Completa la frase con la forma corretta del verbo ХОДИТЬ (Ходить vs Идти)",
        text: "Я {{1}} на все выставки! Мы очень любим живопись, но на все выставки мы не {{2}}, сказать по-правде.",
        words: ["хожу", "ходим", "ходишь", "ходит"],
        correctAnswers: { 1: "хожу", 2: "ходим" }
    },
    {
        instruction: "Completa la frase con la forma corretta del verbo ХОДИТЬ (Ходить vs Идти)",
        text: "Они часто {{1}} в лес за грибами? Да, каждые выходные. Мы {{2}} редко. Хотим выспаться хотя бы в воскресенье.",
        words: ["ходят", "ходим", "ходишь", "ходит"],
        correctAnswers: { 1: "ходят", 2: "ходим" }
    },
    {
        instruction: "Completa la frase con la forma corretta del verbo ХОДИТЬ (Ходить vs Идти)",
        text: "Ты в какой кинотеатр {{1}}? Мне нравится кинотеатр в центре, {{2}} туда обычно.",
        words: ["ходишь", "хожу", "ходит", "ходим"],
        correctAnswers: { 1: "ходишь", 2: "хожу" }
    },
    {
        instruction: "Completa la frase con la forma corretta del verbo ХОДИТЬ (Ходить vs Идти)",
        text: "Бабушка {{1}} к врачу каждую неделю. Думала у неё проблемы со здоровьем, а она {{2}}, чтобы пообщаться.",
        words: ["ходит", "ходит", "ходишь", "ходим"],
        correctAnswers: { 1: "ходит", 2: "ходит" }
    },
    {
        instruction: "Completa la frase con la forma corretta del verbo ХОДИТЬ (Ходить vs Идти)",
        text: "Мы по утрам всегда {{1}} на пробежку. Нужно как-то форму поддерживать. Вы в спортзал {{2}} или на пробежку? Мы {{3}} в ресторан или на аперитив.",
        words: ["ходим", "ходим", "ходите", "ходит"],
        correctAnswers: { 1: "ходим", 2: "ходите", 3: "ходим" }
    },
    {
        instruction: "Completa la frase con la forma corretta del verbo ХОДИТЬ (Ходить vs Идти)",
        text: "Я {{1}} на рынок по воскресеньям. Вы {{2}} на рынок?",
        words: ["хожу", "ходите", "ходит", "ходим"],
        correctAnswers: { 1: "хожу", 2: "ходите" }
    }
];
...
// ============================================================
// PANEL 6 — DragDrop · paid
// ============================================================
const p6exercises = [
    {
        instruction: "Completa la frase con la forma corretta del verbo (Ходить vs Идти)",
        text: "Мы обычно {{1}} завтракать в бар рядом с домом, но сегодня {{2}} в новое кафе.",
        words: ["ходим", "идём", "ходите", "идёте"],
        correctAnswers: { 1: "ходим", 2: "идём" }
    },
    {
        instruction: "Completa la frase con la forma corretta del verbo (Ходить vs Идти)",
        text: "Я {{1}} в спортзал два-три раза в неделю, вот сейчас {{2}} на тренировку.",
        words: ["хожу", "иду", "ходишь", "идёт"],
        correctAnswers: { 1: "хожу", 2: "иду" }
    },
    {
        instruction: "Completa la frase con la forma corretta del verbo (Ходить vs Идти)",
        text: "Вы часто {{1}} в этот ресторан? — Да, почти каждые выходные. Сегодня вечером тоже туда {{2}}.",
        words: ["ходите", "идём", "ходим", "идёте"],
        correctAnswers: { 1: "ходите", 2: "идём" }
    },
    {
        instruction: "Completa la frase con la forma corretta del verbo (Ходить vs Идти)",
        text: "Она часто {{1}} на берег моря. Смотри, вот она {{2}} по берегу прямо сейчас.",
        words: ["ходит", "идёт", "хожу", "иду"],
        correctAnswers: { 1: "ходит", 2: "идёт" }
    },
    {
        instruction: "Completa la frase con la forma corretta del verbo (Ходить vs Идти)",
        text: "Я {{1}} на все выставки! Сегодня вечером открытие новой выставки Пикассо, вот {{2}}.",
        words: ["хожу", "иду", "ходим", "идём"],
        correctAnswers: { 1: "хожу", 2: "иду" }
    },
    {
        instruction: "Completa la frase con la forma corretta del verbo (Ходить vs Идти)",
        text: "Они часто {{1}} в лес за грибами. Смотри, вот они {{2}} — наверное, опять за грибами!",
        words: ["ходят", "идут", "ходим", "идём"],
        correctAnswers: { 1: "ходят", 2: "идут" }
    },
    {
        instruction: "Completa la frase con la forma corretta del verbo (Ходить vs Идти)",
        text: "Ты в какой кинотеатр обычно {{1}}? — В тот, который в центре. В субботу с Марией {{2}} на новый фильм Андерсона.",
        words: ["ходишь", "идём", "ходит", "идут"],
        correctAnswers: { 1: "ходишь", 2: "идём" }
    },
    {
        instruction: "Completa la frase con la forma corretta del verbo (Ходить vs Идти)",
        text: "Бабушка {{1}} к врачу каждую неделю. Завтра утром опять {{2}} в больницу. Я переживаю, бабушка... Не переживай, она туда общаться {{3}}!",
        words: ["ходит", "ходит", "идёт", "иду"],
        correctAnswers: { 1: "ходит", 2: "идёт", 3: "ходит" }
    },
    {
        instruction: "Completa la frase con la forma corretta del verbo (Ходить vs Идти)",
        text: "Вы {{1}} сегодня на пробежку? — Ты же знаешь, мы всегда {{2}}! Подождите нас 5 минут, мы уже одеваемся.",
        words: ["идёте", "ходим", "идём", "ходите"],
        correctAnswers: { 1: "идёте", 2: "ходим" }
    },
    {
        instruction: "Completa la frase con la forma corretta del verbo (Ходить vs Идти)",
        text: "Ты куда? — {{1}} на рынок. — Ты всегда по воскресеньям {{2}}? — Нет, это Рудневы {{3}} каждое воскресенье.",
        words: ["иду", "ходишь", "ходят", "идёт"],
        correctAnswers: { 1: "иду", 2: "ходишь", 3: "ходят" }
    },
];
...
const p2cards = [
    ...
    { front: "Моя соседка никогда", back: "не ходит завтракать в этот бар" },
    { front: "Ты часто", back: "ходишь в спортзал" },
    { front: "Нет я только два-три раза в неделю", back: "хожу в спортзал" },
    { front: "Вы часто сюда", back: "ходите" },
    { front: "Да, в этот ресторан мы почти каждые выходные", back: "ходим" },
    { front: "Она часто", back: "ходит на берег моря" },
    { front: "Я каждое утро", back: "хожу на пробежку по берегу моря" },
    { front: "Они каждые выходные", back: "ходят в лес за грибами" },
