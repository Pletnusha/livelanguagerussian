...
const p3cards = [
    ...
    { front: "Куда ты каждый вечер", back: "ходишь?" },
...
// ============================================================
const p7cards = [
    { front: "Лене очень нравится", back: "ходить по магазинам" },
    ...
    { front: "Она любит", back: "ходить на рынок" },
    { front: "Завтра вечером вы", back: "идёте куда-нибудь" },
    { front: "Мы с друзьями обычно", back: "ходим в один и тот же ресторан" },
...
const p8cards = [
    ...
    { front: "Я", back: "иду в супермаркет" },
...
const p9cards = [
    ...
    { front: "Сегодня вечером", back: "иду к Кате на ужин" },
    { front: "Когда я иду в спортзал", back: "слежу за пульсом" },
...
const p10cards = [
    ...
    { front: "Когда я хочу купить новое платье, я всегда", back: "иду в этот магазин" },
    { front: "Я иду в биллиард", back: "играть с друзьями" },
...
function initPanel4() {
    ...
    const multipleChoiceData = [
        { question: "Она ___ гулять три раза в день.", options: ["ходит", "идёт", "ходят"], answer: "ходит" },
        ...
        { question: "Мы ___ к Кате смотреть фильм.", options: ["идём", "ходим", "идут"], answer: "идём" },
        { question: "Ты опять ___ в салон красоты?!", options: ["идёшь", "ходишь", "ходят"], answer: "идёшь" },
        ...
        { question: "Прямо сейчас они ___ в спортзал.", options: ["идут", "ходят", "идёт"], answer: "идут" },
    ...
    const matchPairs = [
        ...
        { left: "Сегодня вечером мы", right: "идём в ресторан" },
        { left: "Ты часто", right: "ходишь в спортзал?" },
        { left: "Иду", right: "Катю встречать" },
        { left: "Лене очень нравится", right: "ходить по магазинам" },
    ...
    const quizData = [
        { id: "plur-001", promptPrefix: "Мы с Катей договорились вместе", promptSuffix: "по пятницам.", answers: ["ходить"] },
        { id: "plur-002", promptPrefix: "Я уже пять лет", promptSuffix: "на рынок к одной и той же женщине.", answers: ["хожу"] },
        { id: "plur-003", promptPrefix: "Ненавижу", promptSuffix: "на групповые экскурсии!", answers: ["ходить"] },
        { id: "plur-004", promptPrefix: "Лена предпочитает", promptSuffix: "в спортзал.", answers: ["ходить"] },
        { id: "plur-005", promptPrefix: "Мне не нравится", promptSuffix: "за продуктами.", answers: ["ходить"] },
        { id: "plur-006", promptPrefix: "Я", promptSuffix: "в супермаркет, нужно купить вино.", answers: ["иду"] },
        { id: "plur-007", promptPrefix: "Она любит", promptSuffix: "на рынок.", answers: ["ходить"] },
        { id: "plur-008", promptPrefix: "Когда я", promptSuffix: "в гости, всегда покупаю что-нибудь к чаю.", answers: ["иду"] },
        { id: "plur-009", promptPrefix: "Куда ты каждый вечер", promptSuffix: "?", answers: ["ходишь"] },
        { id: "plur-010", promptPrefix: "Сегодня вечером", promptSuffix: "к Кате на ужин.", answers: ["иду"] },
    ];
