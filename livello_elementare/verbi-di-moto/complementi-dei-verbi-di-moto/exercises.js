...
// ============================================================
// PANEL 3 — public · Flashcard · moto per luogo · по/вдоль · con spiegazioni
// ============================================================
const p3cards = [
...
// ============================================================
// PANEL 9 — paid · Flashcard · moto per luogo · по/вдоль
// ============================================================
const p9cards = [
...
// ============================================================
// PANEL 10 — paid · Flashcard · moto per luogo · по/вдоль
// ============================================================
const p10cards = [
    { front: "Нужно подняться ___ (лестница) на третий этаж.",                                                    back: "Нужно подняться по лестнице на третий этаж." },
    { front: "Группа туристов идёт ___ (площадь).",                                                               back: "Группа туристов идёт по площади." },
...
function initPanel4Cdm() {
    ...
    const quizData = [
        { id: "cdm-021", promptPrefix: "Иди",                        promptSuffix: "(двор) до второго подъезда.",                  answers: ["по двору"] },
        { id: "cdm-022", promptPrefix: "Друзья идут",                promptSuffix: "(дорога) — машин нет, тихо.",                  answers: ["вдоль дороги"] },
        { id: "cdm-023", promptPrefix: "Маша и Коля ходят",          promptSuffix: "(рождественский базар).",                      answers: ["по рождественскому базару"] },
        { id: "cdm-024", promptPrefix: "Саша любит ходить летом",    promptSuffix: "(ручей).",                                     answers: ["вдоль ручья"] },
        { id: "cdm-025", promptPrefix: "Нужно подняться",            promptSuffix: "(лестница) на третий этаж.",                   answers: ["по лестнице"] },
        { id: "cdm-026", promptPrefix: "Студенты ходят",             promptSuffix: "(галерея) и делают наброски с картин.",        answers: ["по галерее"] },
        { id: "cdm-027", promptPrefix: "Лена и Антон идут",          promptSuffix: "(пристань), любуются яхтами.",                 answers: ["вдоль пристани"] },
        { id: "cdm-028", promptPrefix: "Посетители ходят",           promptSuffix: "(оранжерея) и любуются орхидеями.",            answers: ["по оранжерее"] },
        { id: "cdm-029", promptPrefix: "Она идёт",                   promptSuffix: "(забор) и ищет вход.",                        answers: ["вдоль забора"] },
        { id: "cdm-030", promptPrefix: "Они идут",                   promptSuffix: "(аллея) старинного парка.",                   answers: ["вдоль аллеи"] },
    ];
