...
// ============================================================
const p7cards = [
    { front: "Хватит", back: "нести чушь — говори по делу!" },
    { front: "В Хогвартсе все студенты", back: "носят мантии — даже на уроках." },
    { front: "Мы два раза в год", back: "носим кота к ветеринару." },
    { front: "Несу подарок Кате —", back: "у неё был день рождения." },
    { front: "Компания", back: "несёт серьёзные потери из-за кризиса." },
    { front: "Зачем ты", back: "несёшь тарелки в комнату?" },
    { front: "Она никогда", back: "не носит платья." },
    { front: "Бабушка летом всегда", back: "носит панамку." },
    { front: "Мне нравится", back: "носить красивую одежду." },
    { front: "Несу очки в ремонт —", back: "они сломались." },
];
...
const p8cards = [
    ...
    { front: "Куда ты несёшь нашего кота?", back: "К ветеринару, он проглотил шарик." },
    { front: "Женя", back: "носит только костюмы." },
    { front: "Несу часы в ремонт —", back: "стекло треснуло." },
    { front: "Мы", back: "несём цветы на свадьбу." },
    { front: "Мы", back: "носим бельё стирать в прачечную." },
    { front: "Она юбки не носит —", back: "думает, что у неё ноги не красивые." },
    { front: "Он носит костюм", back: "только на важные встречи." },
    { front: "Куда ты", back: "несёшь все эти книги?" },
    { front: "Они", back: "несут диван на четвёртый этаж." },
];
